local colors = {
  background_color = {"#000000", "#111111", "#222222", "#333333", "#444444"},
  foreground_color = {"#ffffff", "#dddddd", "#bbbbbb", "#999999", "#777777"},
...
colorscheme = {
  normal = {
    ...
    b = {bg = colors.background_color[5], fg = colors.foreground_color[1]},
  ...
  insert = {
    ...
    b = {bg = colors.background_color[5], fg = colors.foreground_color[1]},
    c = {bg = colors.background_color[5], fg = colors.foreground_color[1]}
  },
  visual = {
    a = {bg = colors.kit_yellow[1], fg = colors.background_color[1], gui = 'bold'},
    b = {bg = colors.background_color[5], fg = colors.foreground_color[1]},
    c = {bg = colors.foreground_color[4], fg = colors.background_color[1]}
  },
  replace = {
    a = {bg = colors.kit_red[1], fg = colors.background_color[1], gui = 'bold'},
    b = {bg = colors.background_color[5], fg = colors.foreground_color[1]},
    c = {bg = colors.background_color[1], fg = colors.foreground_color[1]}
  },
  command = {
  ...
  inactive = {
    ...
    b = {bg = colors.background_color[3], fg = colors.foreground_color[4]},
    c = {bg = colors.background_color[3], fg = colors.foreground_color[4]}
  }
}
