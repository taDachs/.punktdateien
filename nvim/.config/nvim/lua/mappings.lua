...
-- tree
vim.api.nvim_set_keymap('n', '<leader>a', '<cmd>NvimTreeFindFileToggle<cr>', { noremap = true })
...
-- telescope
vim.api.nvim_set_keymap('n', '<leader><C-a>', '<cmd>Telescope find_files<cr>', { noremap = true })
vim.api.nvim_set_keymap('n', '<leader><C-f>', '<cmd>Telescope live_grep<cr>', { noremap = true })
...
-- <C-n> : go to previous
vim.api.nvim_set_keymap('n', '<C-n>', '<cmd>lua vim.diagnostic.goto_prev()<CR>', { silent = true, noremap = true })
-- <C-P> : go to next
vim.api.nvim_set_keymap('n', '<C-p>', '<cmd>lua vim.diagnostic.goto_next()<CR>', { silent = true, noremap = true })
-- Shift+F6 : rename
