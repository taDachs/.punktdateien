...
function M.setup(opts)
  ...
  --   end,
  --   exports = {
  --     incoming = function(opts) M.pickers.zettel_picker(opts, "incoming") end,
  --     outgoing = function(opts) M.pickers.zettel_picker(opts, "outgoing") end,
  --     all = function(opts) M.pickers.zettel_picker(opts, "all") end,
  --   },
  -- }) end
end
