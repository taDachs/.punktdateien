...
-- depends on https://github.com/streetturtle/awesome-wm-widgets
...
globalkeys = gears.table.join(
    ...
    ,awful.key({ modkey }, "d",
               function () awful.spawn.with_shell("rofi -modi drun,window -show drun") end,
    ...
    ,awful.key({  }, "XF86AudioMicMute",
               function () awful.util.spawn("pactl set-source-mute @DEFAULT_SINK@ toggle") end,
               {description = "Mute microphone", group = "multimedia"})
    ,awful.key({  }, "XF86AudioPlay",
               function () awful.util.spawn("playerctl play-pause") end,
               {description = "Play/Pause player", group = "multimedia"})
